				...
				<td class="center">
					<div class="dropdown">
						...
						<div class="dropdown-menu center" aria-labelledby="dropdownMenuButton">
							<a class="form-control" href="{{ route('department.show',$departments->id) }}">{{ trans('department/index.st_show') }} 
								<i class="fa fa-list"></i>
							</a>
							<a class="form-control" href="{{ route('department.edit',$departments->id) }}">{{ trans('department/index.st_edit') }} 
